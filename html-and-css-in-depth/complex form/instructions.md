...
You'll write your code in the **index.html** file in the the **workspace** folder.
```
```
 ...
 * If you need help refer to your cheat sheets and glossary from previous lessons.
 ...
 After completing all the steps you can check your work against the code provided in the **solution** folder.
