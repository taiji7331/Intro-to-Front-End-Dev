...
You'll write your code in the **index.html** file in the **workspace** folder.
```
```
...
**Step 20:** Save the HTML document and open the web page in a new browser tab. Note that video playback is not supported in Live Preview.
 ...
 * If you need help, refer to your cheat sheets and glossary from previous lessons.
 ...
 After completing all the steps, you can compare your code with the **solution** folder.
